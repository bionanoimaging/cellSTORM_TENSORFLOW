...
Java_de_nanoimaging_deconv_ModelManager_loadModelSync(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_de_nanoimaging_deconv_ModelManager_unloadModelSync(JNIEnv *env, jclass type) {
...
Java_de_nanoimaging_deconv_ModelManager_runModelSync(JNIEnv *env, jclass type, jstring jmodelName,
                                                   jfloatArray jbuf) {
